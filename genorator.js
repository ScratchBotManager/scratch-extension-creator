...
Blockly.JavaScript['extensionsetup'] = function(block) {
  ...
  var code = 'class ' + text_extensionname + ' {     getInfo() { "id": ' + text_extensionname + ' }} Scratch.extensions.register(new CustomJSBlocks());';
  return code;
};
...
Blockly.JavaScript['textcontent'] = function(block) {
  ...
  var value_name = Blockly.JavaScript.valueToCode(block, 'NAME', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = text_text.prototype.toString(); value_name;
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, Blockly.JavaScript.ORDER_NONE];
};
