...
Blockly.JavaScript['extensionsetup'] = function(block) {
  ...
  var code = "class "+ text_extensionname +" {  constructor(runtime) {this.runtime = runtime;}  getInfo() { return { id: '"+ text_extensionname +"', name: '"+ text_extensionname +"',  color1: '"+ color +"', blocks: "+ statements_details +"}}} Scratch.extensions.register(new "+ text_extensionname +"());";
  return code;
};
