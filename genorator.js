...
Blockly.Blocks['extensionsetup'] = {
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("Color")
        .appendField(new Blockly.FieldTextInput("hex code"), "color");
...
Blockly.JavaScript['extensionsetup'] = function(block) {
  ...
  var code = "class "+ text_extensionname +" implements ScratchExtension  { getInfo(): ExtensionMetadata { return { id: '"+ text_extensionname +"', name: '"+ text_extensionname +"',  color1: '"+ color +"', blocks: "+ statements_details +"}}} Scratch.extensions.register(new "+ text_extensionname +"());";
  return code;
};
